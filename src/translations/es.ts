export const es = {
  ...
  about: {
    ...
    interestsList: {
      ...
      disenoSoftware: "Diseño de Software",
      cafe: "Café",
      musica: "Música",
      devops: "DevOps"
    }
  ...
  projects: {
    ...
    verDemo: "Ver Demo",
    codigo: "Código",
    verCodigo: "Ver Código Fuente",
    verVistaPrevia: "Ver vista previa",
    aplicacionWeb: "Aplicación Web",
    aplicacionMovil: "Aplicación Móvil",
    disenoUx: "Diseño UI/UX",
    vistaPreviaProyecto: "Vista Previa del Proyecto",
    descripcionWeb: "Aplicación web responsiva con interfaz moderna",
    descripcionMovil: "Aplicación móvil nativa con experiencia optimizada",
    descripcionDesign: "Diseño de interfaz con prototipado interactivo",
    tecnologiasUtilizadas: "Tecnologías Utilizadas",
    verDemoEnVivo: "Ver Demo en Vivo",
    proyectosGitHub: "¿Te gustaron mis proyectos? ¡Hay muchos más en mi GitHub!",
    verTodosGitHub: "Ver todos en GitHub"
  },
  ...
  contact: {
    ...
    description: "¿Tienes un proyecto en mente? ¿Necesitas ayuda con desarrollo o testing? ¡Estoy aquí para ayudarte!",
    form: {
      nombre: "Nombre",
      email: "Email",
      asunto: "Asunto",
